...
class CandidateAcademicSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['candidate_id', 'education', 'degree', 'major', 'graduation_year', 'gpa', 'gpa_max']

class CandidateProfessionalExpSerializer(serializers.ModelSerializer):
    class Meta:
        model = CandidateProfessionalExp
        fields = ['candidate_id', 'company', 'title', 'start_date', 'end_date', 'currently_working', 'description']